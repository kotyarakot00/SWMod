(function(){
        ...
        <div class="sw-content">
            <div class="sw-section">
                ...
                <div class="sw-input-group">
                    <input type="text" id="sw-name-input" placeholder="Новое имя">
            ...
            <div class="sw-section">
                <h4>💰 МОНЕТЫ</h4>
                <div class="sw-input-group">
                    <input type="number" id="sw-coins-input" placeholder="99999">
    ...
    document.getElementById('sw-apply-coins').addEventListener('click',()=>{
        ...
        if(coinEl){
            ...
            showMessage('Монеты изменены визуально!');
            input.value='';
        }else{
